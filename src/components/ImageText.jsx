...
function ImageText( {order, imgMobile, imgDesktop, title, text}) {
  return (
    ...
    <h2 className='text-center font-Fraunces text-[28px] text-Dark-desaturated-cyan mb-7 font-black'>{title}</h2>
