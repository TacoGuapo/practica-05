...
function Nav() {
  ...
  return (
    <nav className='sm:h-[24px]'>
      <ul className={`${menuClicked ? 'flex' : 'hidden'} bg-white py-[39px] w-[329px] h-[305px] absolute left-0 right-0 
      ...
      after:border-r-white text-Very-dark-grayish-blue text-xl z-10
       
       sm:flex sm:after:hidden sm:bg-transparent sm:flex-row sm:top-0 sm:w-[400px]  sm:h-full sm:py-0 sm:relative sm:mt-0
       sm:text-white
       ...
       md:w-[500px]`}>
        ...
        text-Very-dark-desaturated-blue uppercase sm:bg-white sm:hover:bg-opacity-25 sm:hover:text-white'>Contanct</li>
      </ul>
