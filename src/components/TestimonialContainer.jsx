...
function TestimonialContainer() {
  return (
    <section className='bg-white pt-16'>
        <h2 className='text-center uppercase font-Fraunces mb-16 text-Grayish-blue font-black'>Client Testimonials</h2>
        <div className='lg:flex lg:w-[900px] lg:mx-auto xl:w-[1100px]'>
            <Testimonial
            img={emilyPhoto}
